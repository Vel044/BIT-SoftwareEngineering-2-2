...
# 记录不同Dropout比例下的ROC AUC
for dropout_rate in dropout_rates:
    model = create_neural_network(X_train.shape[1], dropout_rate)
    ...
    # 绘制ROC曲线
    plt.plot(fpr, tpr, lw=2, label=f'Dropout rate: {dropout_rate} (AUC = {roc_auc:.2f})')
...
plt.title('ROC Curve for Different Dropout Rates')
