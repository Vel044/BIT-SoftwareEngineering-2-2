...
def create_neural_network(input_dim, optimizer):
    model = Sequential([
...
for name, optimizer in optimizers.items():
    model = create_neural_network(X_train.shape[1], optimizer=optimizer)
    print(f"Training model with optimizer: {name}...")
