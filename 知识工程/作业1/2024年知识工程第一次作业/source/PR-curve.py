from sklearn.metrics import auc, roc_curve, roc_auc_score, classification_report, precision_recall_curve
...
def train_glm(features, labels):
    ...
    model = LogisticRegression(
        solver='liblinear', class_weight='balanced', max_iter=40, tol=1e-5, verbose=1, C=1)
...
plt.plot(recall, precision, marker='.', label='Logistic (AUC-PR = {:.4f})'.format(auc_pr))
plt.xlabel('Recall')
